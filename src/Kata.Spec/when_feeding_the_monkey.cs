...
namespace Kata.Spec
{
    ...
    public class when_user_intput_is_empty
    {
        Establish _context = () =>
        {
    ...
    public class when_user_input_contains_new_line_delimeter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_input_a_random_delimiter
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
    ...
    public class when_input_contains_multiple_negative_numbers
    {
        ...
        It should_raise_an_exception = () => { _result.Message.Should().Be("negatives not allowed: -2, -3, -5"); };
        static Calculator _systemUnderTest;
        static Exception _result;
    };
