...
namespace Kata.Spec
{
    ...
    public class when_user_input_empty
    {
        Establish _context = () =>
        {
    ...
    public class when_input_two_numbers
    {
        ...
        It should_the_sum_of_all = () => { _result.Should().Be(3); };
        static Calculator _systemUnderTest;
        static int _result;
    };
    ...
    public class when_separating_numbers_with_new_line
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
    ...
    public class when_using_custom_delimeter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_input_is_a_negative_number
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_input_numbers_greater_than_1000
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };

        Because of = () => { _result = _systemUnderTest.Add("2,1001"); };
        It should_return_the_sum_of_all_numbers_less_than_1000 = () => { _result.Should().Be(2); };
        static Calculator _systemUnderTest;
        static int _result;
    };

    public class when_user_input_has_multiple_character_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
